...
function Navbar() {
  ...
  return (
    <nav className="flex md:fixed w-screen z-20 items-center justify-between flex-wrap p-4 px-10" style={{backgroundColor:"#102235"}}>
  <div className="flex items-center flex-shrink-0 text-white mr-6">
    {/* <svg className="fill-current h-8 w-8 mr-2" width="54" height="54" viewBox="0 0 54 54" xmlns="http://www.w3.org/2000/svg"><path d="M13.5 22.1c1.8-7.2 6.3-10.8 13.5-10.8 10.8 0 12.15 8.1 17.55 9.45 3.6.9 6.75-.45 9.45-4.05-1.8 7.2-6.3 10.8-13.5 10.8-10.8 0-12.15-8.1-17.55-9.45-3.6-.9-6.75.45-9.45 4.05zM0 38.3c1.8-7.2 6.3-10.8 13.5-10.8 10.8 0 12.15 8.1 17.55 9.45 3.6.9 6.75-.45 9.45-4.05-1.8 7.2-6.3 10.8-13.5 10.8-10.8 0-12.15-8.1-17.55-9.45-3.6-.9-6.75.45-9.45 4.05z"/></svg> */}
    <span className="font-semibold text-xl tracking-tight">
      <Link href={"/"}>
        <img src={Logo.src} width="90px" height={"60px"} alt="logo"/>
      </Link>
      </span>
  </div>
  ...
  <div className={`w-full block ${isOpen} flex-grow lg:flex lg:items-center lg:w-auto md:text-center`}>
    <div className="text-sm lg:flex-grow">
      <Link href="/">
        ...
        <Link href="https://www.jamesdroyce.com/blog" target={"_blank"}>
            <a   className="block mt-4 lg:inline-block lg:mt-0 text-white hover:text-white md:px-4">
              Blog
            </a>
        </Link>
